...
//Initialize a new Cloze object so we can add questions to the array, I added 10.
...
//a Main Menu function uses inquirer to ask the user if they would like to either do basic questions, cloze questions, or add their own cards; then run the function for that choice
//todo: add validation
function mainMenu() {
    inquirer.prompt([{
        type: "list",
        ...
        switch (data.choice) {
            ...
            case "5. EXIT GAME":
                break;
            //default should never happen in theory because the selections are limited
            default:
                throw "ERROR!";
        }
    });
...
//Create a function to ask the Cloze Questions in the clozeCardsArr.
//pass in a count variable that should be zero to start from the beginning
